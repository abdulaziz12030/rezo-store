...
const errorMessages: Record<string, string> = {
  ...
  create: 'تعذر إنشاء حساب الإدارة. تحقق من البريد وكلمة المرور وحاول مجددًا.'
}
      ...
      <div className="mx-auto max-w-md rounded-[32px] bg-white p-8 shadow-soft">
        <div className="text-center">
          ...
          <p className="mt-3 text-sm leading-6 text-stone-600">
            تعمل هذه الصفحة مرة واحدة فقط لإنشاء حساب Owner الأول، ثم تُغلق تلقائيًا.
          </p>
        </div>
        ...
        {!configured || !setupEnabled ? (
          ...
          <form action={bootstrapFirstAdmin} className="mt-8 grid gap-5">
            ...
            <label className="grid gap-2 text-sm font-medium text-stone-700">
              ...
              <span className="text-xs text-stone-500">12 خانة على الأقل.</span>
            </label>
            ...
            <button className="rounded-full bg-brand-navy px-6 py-3 font-bold text-white transition hover:opacity-90">إنشاء حساب Owner</button>
          </form>
        )}
